...
#            'loss': loss,
#            'hidden_nodes_master':hidden_nodes_master,
#            'hidden_nodes_acous':hidden_nodes_acous,
#            'hidden_nodes_visual':hidden_nodes_visual,
#            'input_len':model_input[0].shape[-1],
