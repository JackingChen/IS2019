...
#                    print("DEBUG, lstm model ",h[mod].shape )
            ...
            self.hiddenmaster1=self.hidden_dict['master']
            self.hiddenacous1=self.hidden_dict['acous']
            self.outmaster1=lstm_out
            self.outacous1=h['acous']
            
            sigmoid_out = self.out(lstm_out)
    
            return h['acous'],sigmoid_out
        else:  # For no subnets...
