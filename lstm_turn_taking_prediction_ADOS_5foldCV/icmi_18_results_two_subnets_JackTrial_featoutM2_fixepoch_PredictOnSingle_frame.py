...
no_subnets = False
OVRLPS=False
experiment_top_path = './two_subnets_Model2_fixepoch_PredictOnSingle_frame_{0}/'
        ...
        for parameters in param_list:
            ...
            for test_indx in test_indices:
                ...
                os.path.exists(os.path.join(test_path, name_append_test, 'results.p'))):
                    ...
                    command = [py_env, './run_json_transfer_featout_M2_fixepoch_PredictOnSingle_frame.py'] + arg_list
