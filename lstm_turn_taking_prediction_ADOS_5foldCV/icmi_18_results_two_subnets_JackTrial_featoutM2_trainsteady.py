...
no_subnets = False
OVRLPS=False
experiment_top_path = './two_subnets_Model2_trainsteady_{0}/'
...
returns_lists=[['DMSpc12'],
 ...
 ['r_rt', 'r_rtsd'],
 ['PRMcN'],
 ['adirctc','adirctc1', 'adirctc2', 'adirctc3', 'adirctc4', 'IEDtT'],
 ['adirctc',
  'adirctc1',
  'adirctc2',
  'adirctc3',
        ...
        for parameters in param_list:
            ...
            for test_indx in test_indices:
                ...
                os.path.exists(os.path.join(test_path, name_append_test, 'results.p'))):
                    ...
                    command = [py_env, './run_json_transfer_featout_M2_trainsteady.py'] + arg_list
