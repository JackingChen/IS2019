...
#        optim_instance.add_param_group({"params": torch.tensor([0])})        
    ...
    optim_dense=optim.Adam(model.lstm_visual.parameters( ))
    optimizer_list.append(optim_dense)
...
#                checkpoint['optimizer_state_dict'+str(i)]=optimizer.state_dict()
...
if use_date_str:
    ...
    result_dir_name = result_dir_name +"_"+Model_use+"_"+ name_append+'_loss_'+str(results_save['test_losses'][np.argmin(np.round(results_save['test_losses'], 4))])[2:6]
else:
