...
#    print("Test Filename: ",file_name)
#    print("Test Filename: ",file_name)
#    df_MJ=pd.DataFrame([],columns=[pause_str,'onset'])
#    df_MJ[pause_str]=pause_fscore_MJ
#    df_MJ['onset']=onset_fscore_MJ
    outpath="./{1}/{0}.xlsx".format(file_name,"MJ_result")
    if not os.path.exists("./{0}/".format("MJ_result")):
        os.makedirs("./{0}/".format("MJ_result"))
