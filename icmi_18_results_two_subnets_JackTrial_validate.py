...
no_subnets = False
OVRLPS=False
experiment_top_path = './two_subnets_Model0_validate_local_{0}/'
...
returns_lists=[['adirctc3', 'adirctc4', 'DMSB', 'rn_omis'],
 ['adirctc3', 'adirctc4', 'DMSceP', 'rn_omis'],
 ['adirctc3', 'DMSceP', 'IEDtT', 'rn_omis'],
 ['adirctc4', 'DMSA', 'DMSceP', 'IEDtT'],
 ['SRMcN', 'DMSA', 'DMSB', 'DMSeeP', 'MTSpC'],
 ['PRMcN', 'DMSA', 'DMSB', 'DMSeeP', 'MTStnC'],
 ['DMSA', 'DMSB', 'DMSeeP', 'MTStnC', 'RVPfaP'],
 ['DMSA', 'DMSB', 'DMSeeP', 'rn_omis', 'rn_comis'],
 ['DMSA', 'DMSB', 'DMSeeP', 'RVPfaP', 'rp_comis'],
...
for id_features in returns_lists:
    ...
    #    test_list_path = './data/splits/testing_{0}.txt'.format(training_i%5)
        ...
        Acous_50ms_ADOS_ID = {
            ...
            'hidden_nodes_visual': 2*len(id_features),
