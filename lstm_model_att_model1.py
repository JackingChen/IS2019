...
# =============================================================================
'''
    Model1: lstmout= lstm['master'](torch.cat(h_ADOSid_acous_hid * h_acous))
